...
public class PayContext {
    ...
    public PayContext() {
        ...
        payServiceMap.put(AliPayServiceImpl.class.getSimpleName(), new AliPayServiceImpl());
        payServiceMap.put(WeChatPayServiceImpl.class.getSimpleName(), new WeChatPayServiceImpl());
        payServiceMap.put(BandCardPayServiceImpl.class.getSimpleName(), new BandCardPayServiceImpl());
    }
